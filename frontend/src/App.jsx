...
function App() {
  ...
  const handleSingleScore = async () => {
    ...
    try {
      const response = await axios.post('http://100.89.110.102:8000/api/score-article', payload);
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await axios.post('http://100.89.110.102:8000/api/score-cv', formData);
